            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form  action="{{ route('update.testimonial') }}" method="POST" enctype="multipart/form-data" id="myForm"
                                class="row g-3">
                                @csrf
                                ...
                                <input type="hidden" name="id" value="{{$testimonial->id}}">
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" name="description" rows="3">{{$testimonial->description}}</textarea>
                                </div>
