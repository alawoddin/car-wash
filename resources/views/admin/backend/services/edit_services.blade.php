            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form  action="{{ route('update.services') }}" method="POST" enctype="multipart/form-data" id="myForm"
                                class="row g-3">
                                @csrf
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <img id="showImage" src="{{ asset($services->image) }}"
                                        class="rounded-circle avatar-xl img-thumbnail float-start" alt="image profile">
                                </div>

                                <div class="form-group col-md-6">
                                    <label  for="validationDefault01" class="form-label">Heading</label>
                                    <input   type="text" class="form-control" name="heading" value="{{ $services->heading }}">
                                </div>

                                 <div class="col-md-6">
                                    <label for="validationDefault02" class="form-label">Information</label>
                                    <textarea class="form-control" name="info" rows="3">{{$services->info}}</textarea>
                                </div>
